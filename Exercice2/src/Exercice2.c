/*
 ...
 Author      : BinderL
 Version     : V1
 Copyright   : help of openSSL datasheet 
 Description : how to generate in C a private/public key using OpenSSL and the Elliptic-curve (EC) cryptography framework. Input : 128 generated hash : "secp128r1"
 ============================================================================
 */
...
int main(void)
{
	...
	* ---------------------------------------------------------- */
	eccgrp = OBJ_txt2nid("secp128r1"); // secp521r1 : type of curve
